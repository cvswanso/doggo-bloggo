...
@section('content')
    ...
    <form method="post" action="{{ route('post.update', ['id' => $post->id]) }}">
        ...
        <div class="mb-3 form-group row">
            ...
            <input type="text" name="name" class="form-control" value="{{(old('name') != null) ? old('name') : $post->name}}">
        </div>
        <div class="mb-3 form-group row">
        ...
        <div class="mb-3">
            ...
            <textarea id="content" name="content" class="form-control">{{(old('content') != null) ? old('content') : $post->content}}</textarea>
        </div>
